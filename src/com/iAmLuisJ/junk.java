...
public class junk {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Shortcut for println is shout"); //shortcut
        ...
        //casting - to caste a data type, put the type in parenthesis before the variable
        int myValue = 1;
        ...
        //HashSet - an array where each element has to be unique, so you can add something twice and it wil only show up once
        ...
        //Iterator, creates a way to track loops and allows you to modify specific index of the array while looping
        Iterator<String> myIterator = myHashSet.iterator();
        //this passes the indexes of the array to the iterator, which has a next() and hasNext() method
